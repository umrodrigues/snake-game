    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createBoardElements() {
            ...
            elmHighscorePanel.innerHTML = "Maior pontuação: " + (localStorage.jsSnakeHighScore || 0);
        ...
        function createWelcomeElement() {
            ...
            if (config.fullScreen) {
                fullScreenText = "Aperte F11 para colocar o jogo em tela cheia.";
            }
            welcomeTxt.innerHTML = "Snake game<p></p>Use as <strong>teclas direcionais</strong> no seu teclado para jogar. " + fullScreenText + "<p></p>";
